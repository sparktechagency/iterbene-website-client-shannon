    ...
    <>
      ...
      <div className="w-full bg-white rounded-2xl relative mt-[72px] md:mt-[88px] lg:mt-[112px]">
        ...
        <div className="relative group">
          {userData?.coverImage ? (
            <div className="relative w-full h-[200px] sm:h-[280px] md:h-[360px] overflow-hidden rounded-t-2xl cursor-pointer">
              <Image
            ...
            <div className="w-full h-[200px] cursor-pointer sm:h-[280px] md:h-[360px] bg-gradient-to-br from-gray-100 via-gray-200 to-gray-300 rounded-t-2xl flex items-center justify-center">
          ...
          {/* Camera Icon Overlay */}
          <div className="absolute bottom-5 right-6 bg-black/10 bg-opacity-0 group-hover:bg-opacity-30 transition-all duration-300 rounded-t-2xl flex items-center justify-center cursor-pointer">
            <button
              onClick={() => handleImageSelect('cover')}
              className="bg-white/90 backdrop-blur-2xl  px-5 py-2 rounded-lg shadow-lg border border-gray-200 cursor-pointer flex items-center gap-2"
            >
