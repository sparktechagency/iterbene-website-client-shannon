...
//   // Get current user ID from your auth system - adjust this based on your auth implementation
//   const [currentUserId, setCurrentUserId] = useState<string | null>(null);

//   useEffect(() => {
//     // Get current user ID from localStorage, Redux, or your auth context
...
//       }
//     };
//   }, [currentMediaIndex, isPaused, currentStory]);
...
//   // Check if current story belongs to the logged-in user
//   const isMyStory = currentStory?.userId?._id === currentUserId;

//   // Get view count and reaction count for my stories
...
//                       <p
//                         className="text-white text-center text-xl font-bold break-words max-w-full"
//                         style={{
//                           fontFamily: currentMedia.textFontFamily || "inherit",
...
//         <div className="absolute bottom-0 left-0 right-0 z-30 p-4">
//           {isMyStory ? (
//             /* My Story - Show view and reaction counts */
//             <div className="flex items-center justify-between bg-black/20 rounded-full px-4 py-3">
...
//               <button
//                 onClick={() => {
//                   // Navigate to story viewers/analytics page
//                   router.push(`/story/${currentStory._id}/viewers`);
//                 }}
...
//             </div>
//           ) : (
//             /* Other's Story - Show reply and reaction options */
//             <div className="flex items-center gap-3">
//               <div className="flex-1 flex items-center bg-transparent border border-gray-400 rounded-full px-4 py-2">
//                 <input
//                   type="text"
...
//           <button
//             onClick={handlePrev}
//             className="absolute left-4 top-1/2 transform -translate-y-1/2 z-30 p-2 rounded-full bg-black/20 text-white hover:bg-black/40 transition-colors"
//             disabled={currentStoryIndex === 0 && currentMediaIndex === 0}
//           >
//             <ChevronLeft className="w-6 h-6" />
//           </button>
//           <button
//             onClick={handleNext}
//             className="absolute right-4 top-1/2 transform -translate-y-1/2 z-30 p-2 rounded-full bg-black/20 text-white hover:bg-black/40 transition-colors"
//           >
//             <ChevronRight className="w-6 h-6" />
//           </button>
//         </div>
...
//           <div className="flex flex-col gap-4 max-h-96 overflow-y-auto">
//             {allStories.map((story, index) => {
//               const isCurrentUserStory = story.userId?._id === currentUserId;
//               return (
//                 <div
//                   key={story._id}
//                   className={`relative w-16 h-16 rounded-full p-0.5 cursor-pointer transition-all ${
//                     index === currentStoryIndex
//                       ? "bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500"
//                       : isCurrentUserStory
...
//                 <div
//                   key={story._id}
//                   className={`relative flex-shrink-0 w-12 h-12 rounded-full p-0.5 cursor-pointer transition-all ${
//                     index === currentStoryIndex
//                       ? "bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500"
//                       : isCurrentUserStory
//                       ? "bg-gradient-to-r from-blue-500 to-green-500"
