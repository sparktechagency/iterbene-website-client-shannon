      ...
      {storiesData?.data?.attributes?.totalPages > 1 && (
        <div className="flex justify-center items-center gap-4 mt-4">
          <div
            ...
            className={`px-4 py-2 bg-primary text-white rounded-xl ${page === 1 ? "opacity-50 cursor-not-allowed" : "cursor-pointer"}`}
          >
            Previous
          </div>
          ...
          <div
            ...
            className={`px-4 py-2 bg-primary text-white rounded-xl ${!storiesData?.data?.attributes?.hasNextPage ? "opacity-50 cursor-not-allowed" : "cursor-pointer"}`}
          >
            Next
          </div>
        </div>
