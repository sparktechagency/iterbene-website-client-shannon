          ...
          <div className="flex gap-5">
            <button
              ...
              className="text-primary cursor-pointer
               bg-[#E9F8F9] border border-primary font-medium px-10 py-3 rounded-xl hover:bg-primary hover:text-white transition-colors"
            >
              Invite
            </button>
            <button className="text-black cursor-pointer bg-transparent border border-[#9194A9] font-medium px-8 py-3 rounded-xl hover:bg-gray-50 transition-colors">
              Remove
            </button>
          </div>
        </div>
